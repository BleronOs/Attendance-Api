...
{
    public class ReadOnlyChecksByEmployeeIdAndDateTimeSpecification : Specification<Check>
    {
        public ReadOnlyChecksByEmployeeIdAndDateTimeSpecification(DateTime dateTime, int employeeId)
        {
            ...
            Query
                ...
                .Where(s => s.Card.EmployeeId == employeeId).AsNoTracking();
        }
    }
}
