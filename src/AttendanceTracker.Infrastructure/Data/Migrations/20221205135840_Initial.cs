        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    registrationdate = table.Column<DateTime>(name: "registration_date", type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    roleclaimid = table.Column<int>(name: "role_claim_id", type: "integer", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_role_claim", x => x.roleclaimid);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    userclaimid = table.Column<int>(name: "user_claim_id", type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    userid = table.Column<string>(name: "user_id", type: "text", nullable: false),
                    claimtype = table.Column<string>(name: "claim_type", type: "text", nullable: true),
                    claimvalue = table.Column<string>(name: "claim_value", type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_claim", x => x.userclaimid);
                    table.ForeignKey(
